...
function createGeneralTabGroups(element, bpmnFactory, elementRegistry, elementTemplates, customOptions) {
  ...
  userTaskProps(detailsGroup, element, customOptions);
...
function CamundaPropertiesProvider(eventBus, bpmnFactory, elementRegistry, elementTemplates) {
  ...
  this.setCustomOptions = function(customOptions) {
